...
// Dynamically import the ocr-text-finder page to avoid SSR issues
const OCRTextFinderPage = dynamic(() => import("../../../ocr-text-finder/page"), {
  ssr: false,
});

export default function TemplateOCRTextFinderPage() {
