...
// Dynamically import the incidents page to avoid SSR issues
const IncidentsPage = dynamic(() => import("../../../incidents/page"), {
  ssr: false,
});

export default function TemplateIncidentsPage() {
