                ...
                {[1, 2, 3, 4, 5, 6].map((i) => (
                  <div key={i} className="bg-gray-800 border-gray-700 rounded-lg p-6 animate-pulse">
                    ...
                    <div className="flex items-center text-sm text-gray-400 mb-3">
                      <div className="w-4 h-4 bg-gray-700 rounded mr-1"></div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center text-sm">
                        ...
                        <div className="h-3 bg-gray-700 rounded ml-auto w-24"></div>
                      </div>
                      <div className="flex items-center text-sm">
                        <div className="w-4 h-4 bg-gray-700 rounded mr-2"></div>
                        <div className="h-3 bg-gray-700 rounded w-20"></div>
                        <div className="h-3 bg-gray-700 rounded ml-auto w-20"></div>
                      </div>
                      <div className="text-sm">
                        <div className="w-4 h-4 bg-gray-700 rounded inline mr-1"></div>
                        <div className="h-3 bg-gray-700 rounded inline w-4/5"></div>
                      </div>
